...
function Header() {
  return (
    <div className="z-50 bg-white py-6 shadow-[0_3px_20px_0px_rgba(0,0,0,0.11)]">
      <nav className="mx-auto flex max-w-screen-2xl justify-between px-4 md:px-10 2xl:px-0">
        ...
        <div className="flex gap-12">
          ...
          <Link href="/hiring">
            <a>
              <button className="rounded-lg bg-custom-yellow1 py-3 px-6 font-alfa text-xl text-custom-brown1 hover:opacity-70">
                Post a job
              </button>
            </a>
          </Link>
