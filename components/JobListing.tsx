...
const JobListing: React.FC<{
  ...
  return (
    <div id="jobs" className="site-margins relative mx-auto mb-10 max-w-7xl">
      <div
...
-translate-y-1/2 transform text-center"
      ...
      {jobs?.length < 1 && (
        <div className="text-center">
          <p>No sustainable jobs found for '{search}'.</p>
          <p>Set an alert or sign up for our newsletter to stay tuned!</p>
        </div>
      )}
    </div>
  );
