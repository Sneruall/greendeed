...
function SimilarJobItem({ job }: Props) {
  ...
  return (
    <Link
      ...
      legacyBehavior
    >
      <div className="shadow-4 hover:shadow-2-extra relative mx-8 h-full max-w-sm flex-initial cursor-pointer rounded-3xl border-4 border-custom-green5 bg-custom-green3 bg-[url('/images/main/bg-topo.png')] bg-cover bg-repeat">
