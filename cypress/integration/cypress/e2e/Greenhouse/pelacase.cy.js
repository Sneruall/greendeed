...
describe('Scrape Greenhouse job positions and extract details', () => {
  ...
  it('Retrieve job position links from Greenhouse-hosted job listings', () => {
    cy.visit('https://boards.greenhouse.io/pelacase'); // Replace with the target Greenhouse job listing page
      ...
      jobLinks.forEach((link) => {
        ...
        cy.document().then((doc) => {
          ...
          const jobData = {
            ...
            companyData: { name: 'Lomi' }, // Replace with the correct company name
            jobTitle: jobTitle,
